...
$config->custom->session['blowfish'] = '35c05550802cf4a3c5a97c11ed827805';  # Autogenerated for ldap-tester.ziyotek6.local
...
$servers->setValue('server','base',array('dc=ziyotek6,dc=local'));
...
$servers->setValue('login','bind_id','cn=admin,dc=ziyotek6,dc=local');
